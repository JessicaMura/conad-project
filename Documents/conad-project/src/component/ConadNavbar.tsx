...
const ConadNavbar = () => {
  ...
  <div className="Navbar">
    ...
    <img className="rt022-picture rt022-picture--init rt022-picture--cover rt051-header__logoStandard "
     style={{objectPosition: "center center"}} 
     src="/assets/icons/conad-logo.svg?_u=e442f961aafe40e5fe7c95186a2850aa925c8284" 
     data-component="" alt="Conad - persone oltre le cose" id="rt022-picture-0"/>
  </div>
